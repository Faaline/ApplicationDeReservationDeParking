...
@RestController
@RequestMapping("/api/application-de-gestion-boutique-kafka")
public class ApplicationDeGestionBoutiqueKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ApplicationDeGestionBoutiqueKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ApplicationDeGestionBoutiqueKafkaResource(KafkaProperties kafkaProperties) {
