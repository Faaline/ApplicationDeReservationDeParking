...
import sn.diagne.gestionboutique.config.KafkaProperties;

class ApplicationDeGestionBoutiqueKafkaResourceIT {
    ...
    void setup() {
        ...
        ApplicationDeGestionBoutiqueKafkaResource kafkaResource = new ApplicationDeGestionBoutiqueKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/application-de-gestion-boutique-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/application-de-gestion-boutique-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
